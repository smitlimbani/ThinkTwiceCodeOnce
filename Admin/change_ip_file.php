<?php
  ...
  if(mysqli_query($link,$sql)) {
    header("location:io_files.php?msg=Input File Uploaded Successfully.&active=$prob");
    exit;
  }
  else {
    echo mysqli_error($link);
//    header("location:io_files.php?msg=Error in uploading Input File.Please Try Again&active=$prob");
    exit;
  }
}
?>
