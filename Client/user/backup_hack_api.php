...
class HackApi
{
	...
	public function init($lang,$code,$inp,$tlimit,$mlimit)
	{
		...
		$this->parameters="client_secret=".$this->client_secret."&source=".$this->source_code."&lang=".$this->language."&input=".$this->input."&time_limit=".$this->time_limit."&memory_limit=".$this->memory_limit;
